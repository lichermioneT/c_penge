...
// {
//    strcmp( ((struct student*)e1)->name , ((struct student*)e2)->name);
// }
...
//     struct student s[] ={{"zhangsan", 15}, {"lisi", 30}, {"wangwu", 25}};
...
void swap(char* buf1, char* buf2, int widtn)
{
    int i = 0;
    for(i = 0; i < widtn; i++)
    {
...
void bubble_sort(void* base, int sz, int width, int(*cpm)(const void* e1,const void* e2))
{
